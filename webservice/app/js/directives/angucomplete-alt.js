...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', [] )
    ...
    $templateCache.put(TEMPLATE_URL,
        ...
        '    <div class="angucomplete-row" ng-repeat="result in results | limitTo: limitTo" ng-click="selectResult(result)" ng-mouseenter="hoverRow($index)" ng-class="{\'angucomplete-selected-row\': $index == currentIndex}">' +
